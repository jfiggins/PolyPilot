...
public static class SettingsRegistry
{
    ...
    private static List<SettingDescriptor> Build()
    {
        ...
        list.Add(new SettingDescriptor
        {
            ...
            Description = "Report PolyPilot status to Home Assistant sensors whenever state changes.",
            Category = "Integrations",
            Section = "Home Assistant",
            Type = SettingType.Custom,
            Order = 10,
            SearchKeywords = "home assistant ha integration webhook sensor status report url token",
        });
